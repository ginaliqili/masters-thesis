step 1: Download yearly (1979-1988) reanalysis data from gridMET http://www.climatologylab.org/gridmet.html using THREDDS catalog (OPENDAP) option and downloading from the HTTPServer
